...
class SvgExecuter{
    ...
    enum class Curve {NONE, CUBIC_BEZIER, QUADRATIC_BEZIER}; 
    ...
    void pushCubicBezierTo(){
        ...
        pushBezierDecomposition();
    }

    void pushQuadraticBezierTo(){
        curveToComplete=Curve::QUADRATIC_BEZIER;
        curveStart=position;
        curveControl1.x=extractParamFromPath();
        curveControl1.y=-extractParamFromPath();
        curveControl2 = curveControl1;
        curveTarget.x=extractParamFromPath();
        curveTarget.y=-extractParamFromPath();
    ...
    void pushBezierDecomposition(){
        ...
        pushNextBezierSegment();
    }

    void pushNextBezierSegment(){
